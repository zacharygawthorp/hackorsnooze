...
function navShowStoryFormClick(evt) {
  console.debug("navShowStoryFormClick", evt);
  hidePageComponents();
  $allStoriesList.show();
  $submitForm.show();
}

$navSubmitStory.on("click", navShowStoryFormClick);

/** Show fav stories on click on "favorites" */
